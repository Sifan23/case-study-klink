  ...
  return (
    <footer className="w-full pt-20 pb-10" id="contact">
      ...
      bg-white p-2 relative cursor-pointer"
        ...
        <hr className="w-full border-t border-black opacity-10  md:hidden" />

        {/* Second Paragraph with Equal Spacing */}
        <div className="flex flex-col justify-center items-start text-left py-8 opacity-20 w-full  md:hidden">
